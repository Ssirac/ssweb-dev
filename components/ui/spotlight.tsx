...
// Card-scoped cursor spotlight (ibelick). Distinct from the global
// background/spotlight — this one lives inside a hovered container.
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "from-primary/40 via-secondary/25 to-transparent",
